...
public class UserServices {
	...
	public void createUser() throws ServletException, IOException{
		...
		if (existUser != null) {
			...
			UtilityClass.showMessageBackEnd(message, request, response);
	...
	public void deleteUser() 
		...
		if(userById==null) {
			 ...
			 String message="User having "+"  " +userId+" has been deleted succesfully";
				request.setAttribute("message", message);
		...
		String message="User having userid  "+userId+"  has been deleted succesfully";
		listUser(message);
	}
	}
